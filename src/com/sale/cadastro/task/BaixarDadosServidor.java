...
public class BaixarDadosServidor extends AsyncTask<Integer, Double, String> {

	private Activity context;
	private ProgressDialog progress;

	public BaixarDadosServidor(Activity context) {
		...
		try {
			...
			if (length > 0) {
				for (int i = 0; i < length; i++) {
					...
					cpf_cnpj = oneObject.getString("cpf_cnpj");
					observacao = oneObject.getString("observacao");
					situacao_cadastro = oneObject.getString("situacao_cadastro");
			...
			for (int i = 0; i < cities.length; i++) {
				...
				pessoa.setCpf_cnpj(oneObject.getString("cpf_cnpj"));
				pessoa.setObservacao(oneObject.getString("observacao"));
				pessoa.setSituacao_cadastro(oneObject.getString("situacao_cadastro"));
				pessoas.add(pessoa);
	...
	protected void onPostExecute(String result) {
		...
		context.startActivity(new Intent(context, MenuInicial.class));
