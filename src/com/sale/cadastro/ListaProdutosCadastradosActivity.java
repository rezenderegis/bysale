...
public class ListaProdutosCadastradosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lista.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapter, View view,
				...
				// TODO Auto-generated method stub
				produto = (ProdutoDTO) adapter.getItemAtPosition(position);
				System.out.println("ID produto "+produto.getIdProduto()+"ID CATEGORIA"+produto.getIdCategoria());
		...
		editarProduto.setOnMenuItemClickListener(new OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem item) {
				...
				Intent editarProdutoCadastrado = new Intent(
						ListaProdutosCadastradosActivity.this,
	...
	public void carregarLista() {
		...
		SaleDAO dao = new SaleDAO(this);
		List<ProdutoDTO> produtoDTO = dao.getListaProdutoComCategoria();

		dao.close();

		ListaProdutosCadastradosAdapter adapter = new ListaProdutosCadastradosAdapter(produtoDTO, this, this);
		lista.setAdapter(adapter);
	}
