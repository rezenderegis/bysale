...
public class FormularioPagamentoHelper {

	private EditText valor_pagamento;
	private EditText data_pagamento_informada;
	private Pagamento pagamento;

	public FormularioPagamentoHelper(PagamentoActivity pagamentoActivity) {
		// TODO Auto-generated constructor stub

		valor_pagamento = (EditText) pagamentoActivity
				.findViewById(R.id.valor_pagamento);
		data_pagamento_informada = (EditText) pagamentoActivity
